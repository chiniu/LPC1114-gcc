...
INC_DIRS = ./config ./cmsis ./driver ./lib_small_printf_m0/inc
...
SRCS_DIRS = ./src ./driver ./cmsis ./startup ./lib_small_printf_m0/src
...
# flags for linker
LD_FLAGS = -T$(LD_SCRIPT) -g -Wl,-Map=$(OUT_DIR_F)$(PROJECT).map,--cref,--no-warn-mismatch,--allow-multiple-definition
